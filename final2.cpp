...
//The revolving horizontal platform
    {
        b2PolygonShape shape;
        shape.SetAsBox(10.5f, 0.2f);

        b2BodyDef bd;
        bd.position.Set(-8.0f, 1.5f);
        bd.type = b2_dynamicBody;
    ...
    //negative gravity balls
    {
        ...
        for(int i=0;i<8;i++)
        {
            b2BodyDef bd;
            bd.type = b2_dynamicBody;
            bd.position.Set(9.6+0.5*i, 0.0f);
            b2Body* body = m_world->CreateBody(&bd);
            body->SetGravityScale(-5.5);
            body->CreateFixture(&fd);
        }
    ...
    //right box to stop table
    {
        ...
        b2BodyDef bd;
        bd.position.Set(10.0f+5.0f, 23.0f-15.0f);
        b2Body* ground = m_world->CreateBody(&bd);
        ground->CreateFixture(&shape, 0.0f);
    }
    ...
    //right box to support table
    {
        ...
        b2BodyDef bd;
        bd.position.Set(10.0f+5.7f, 15.5f-15.0f);
        b2Body* ground = m_world->CreateBody(&bd);
        ground->CreateFixture(&shape, 0.0f);
    }
    ...
    //left box to support table
    {
        ...
        b2BodyDef bd;
        bd.position.Set(10.0f+-3.0f, 15.5f-15.0f);
        b2Body* ground = m_world->CreateBody(&bd);
        ground->CreateFixture(&shape, 0.0f);
    }
...
// table
    {
        ...
        b2BodyDef bd;
        bd.type=b2_dynamicBody;
        bd.position.Set(6.35f, 0.5f);
        leg1 = m_world->CreateBody(&bd);
        leg1->CreateFixture(&shape, 0.0f);
        }
        ...
        b2BodyDef bd;
        bd.type=b2_dynamicBody;
        bd.position.Set(18.35f, 0.5f);
        leg2= m_world->CreateBody(&bd);
        leg2->CreateFixture(&shape, 0.0f);
        }
        ...
        b2BodyDef bd;
        bd.type = b2_dynamicBody;
        bd.position.Set(11.35f+0.0f, 16.0f-15.0f);
        b2Body* body = m_world->CreateBody(&bd);
        body->CreateFixture(&fd);

        b2RevoluteJointDef jointDef1;
        jointDef1.bodyA = body;
        jointDef1.bodyB = leg1;
        jointDef1.localAnchorA.Set(-5,0);
        jointDef1.localAnchorB.Set(0,1);
        jointDef1.collideConnected = false;
        m_world->CreateJoint(&jointDef1);

        b2RevoluteJointDef jointDef2;
        jointDef2.bodyA = body;
        jointDef2.bodyB = leg2;
        jointDef2.localAnchorA.Set(5,0);
        jointDef2.localAnchorB.Set(0,1);
...
/////////////////////clamps//////////////////
    ...
    /*{
        ...
        b2BodyDef bd;
        bd.position.Set(10.0f+9.0f, 23.0f-15.0f);
        b2Body* ground = m_world->CreateBody(&bd);
        ground->CreateFixture(&shape, 0.0f);
    }
    //clamp
    {
        ...
        b2BodyDef bd;
        bd.position.Set(10.0f+12.0f, 23.0f-15.0f);
        b2Body* ground = m_world->CreateBody(&bd);
        ground->CreateFixture(&shape, 0.0f);
    }
//clamp
...
///////////left hinge-rod pair involved n formation of table
  /*  {
        b2Body* b2;
        {
            ...
            b2BodyDef bd;
            bd.position.Set(10.0f+9.0f, 22.0f-18.0f);
            //   b2Body* ground = m_world->CreateBody(&bd);
            // ground->CreateFixture(&shape, 0.0f);
            b2 = m_world->CreateBody(&bd);
            b2->CreateFixture(&shape, 10.0f);
        ...
        b2Vec2 anchor;
        anchor.Set(10.0f+9.0f, 22.0f-18.0f);
