...
// left motor
  ...
  {
      b2PolygonShape shape;
      shape.SetAsBox(7.0f, 0.01f);
  
      b2BodyDef bd;
      bd.position.Set(37.0f, 28.4f);
       b20 = m_world->CreateBody(&bd);
      m_sensor2 = b20->CreateFixture(&shape, 0.0f);
    //   b20->CreateFixture(&shape, 0.0f);
    }
//lower cardboard
    {
      b2PolygonShape shape;
      ...
      b2BodyDef bd;
      bd.position.Set(37.0f, 25.6f);
      b2Body* ground = m_world->CreateBody(&bd);
      ground->CreateFixture(&shape, 0.0f);

    }

    ///////////////////////////////////////////////////right conveyor belt ends //////////////////////////////////
...
//G part
    {
        ...
        bd.position.Set(40.0f, 30.0f);
        bd.type = b2_dynamicBody;
        b2Body* g4 = m_world->CreateBody(&bd);
        m_sensor3 = g4->CreateFixture(&shape, 0.0f);
