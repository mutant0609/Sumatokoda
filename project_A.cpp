...
namespace cs251
{
  ...
  dominos_t::dominos_t()
  {
    ...
    */
    ...
    {
      b2PolygonShape shape;
      shape.SetAsBox(8.0f, 0.15f, b2Vec2(-20.f,20.f), 0.0f);
...
//firstdown1 from the middle hor shelf
    {
      b2PolygonShape shape;
      shape.SetAsBox(3.0f, 0.15f, b2Vec2(-20.f,20.f), 0.0f);
...
//firstup1 from mid hor shelf
    {
      b2PolygonShape shape;
      shape.SetAsBox(2.3f, 0.15f, b2Vec2(-20.f,20.f), 0.0f);
...
//top hor shelf
    {
      b2PolygonShape shape;
      shape.SetAsBox(2.5f, 0.15f, b2Vec2(-20.f,20.f), 0.0f);
    ...
    // // // // // //
    /*This code is related to conveyor belt
    // Ground
    {
      b2BodyDef bd;
      b2Body* ground = m_world->CreateBody(&bd);
